        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            <div className="w-full flex justify-between items-start">
              ...
              <span className="text-[9px] font-mono text-purple-500/80 bg-purple-500/5 px-1.5 py-0.5 rounded">
                2h ago
              </span>
            </div>
          ...
          >
            <div className="w-full flex justify-between items-start">
              ...
              <span className="text-[9px] font-mono text-emerald-500/80 bg-emerald-500/5 px-1.5 py-0.5 rounded">
                1.2 km
              </span>
            </div>
            <div className="flex flex-col items-start">
          ...
          >
            ...
            <div className="w-full flex flex-col items-start gap-1.5">
              <span className="text-sm font-bold text-zinc-300 group-hover:text-white transition-colors">
                {t("safety_plan" as any) || "Safety Plan"}
              </span>
